...
def get_infoMatrix(e,start_time):
    ...
    for x in range(1,num_orders):
        ...
        endTimeOrderLimit = int(latest_timeOrder - w[2 * x - 1][2 * x])
        randomStartTimeOrder = int(random.randrange(startTimeOrderLimit, endTimeOrderLimit))
        randomEndTimeOrder = int(randomStartTimeOrder + w[2 * x - 1][2 * x] + (time_deviation * 60))
        ...
        time_windows.append((0,14400 + (wait_time * 60)))
